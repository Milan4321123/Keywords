...
const RELATION_TYPES: { value: RelationType; label: string; icon: string }[] = [
  ...
  { value: 'affects', label: 'Affects', icon: '∿' },
  { value: 'enables', label: 'Enables', icon: '⊕' },
  { value: 'uses', label: 'Uses', icon: '⚒' },
  { value: 'generated-by', label: 'Generated By', icon: '⚙' },
  { value: 'measured-by', label: 'Measured By', icon: '📏' },
  { value: 'reported-in', label: 'Reported In', icon: '▤' },
  { value: 'calculated-from', label: 'Calculated From', icon: '∑' },
  { value: 'validated-by', label: 'Validated By', icon: '☑' },
  { value: 'conflicts-with', label: 'Conflicts With', icon: '✕' },
  { value: 'replaces', label: 'Replaces', icon: '⇄' },
  { value: 'derived-from', label: 'Derived From', icon: '↩' },
  { value: 'belongs-to', label: 'Belongs To', icon: '⌂' },
];
