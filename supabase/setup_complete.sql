-- =====================================================================
-- COMPLETE SETUP — Company Brain platform
-- Paste this entire file into the Supabase SQL Editor and run ONCE.
-- It combines schema.sql + migrations 0002–0005 in the correct order.
-- Safe on a fresh project. Do not run on a database that already has
-- data unless you know schema.sql was previously applied.
-- =====================================================================
